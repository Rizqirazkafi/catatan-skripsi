	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\hline
				1                                          & 3m38.709s & 0m12.379s & 0m11.836s \\
				\hline
				2                                          & 3m34.648s & 0m12.282s & 0m11.082s \\
				\hline
				3                                          & 3m39.477s & 0m12.199s & 0m11.162s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                              \\
				\hline
				1                                          & 3m31.792s & 0m12.334s & 0m11.336s \\
				\hline
				2                                          & 3m33.855s & 0m12.200s & 0m11.512s \\
				\hline
				3                                          & 3m35.859s & 0m12.278s & 0m11.968s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
		...
		\begin{table}[H]
			...
			\begin{center}
				\begin{tabular}[c]{|c|c|c|c|}
					...
					\multicolumn{1}{c|}{\textbf{sys}}                                            \\
					\hline
					1                                          & 1m40.721s & 0m3.563s & 0m6.304s \\
					\hline
					2                                          & 1m39.842s & 0m3.500s & 0m6.616s \\
					\hline
					3                                          & 1m40.714s & 0m3.463s & 0m6.367s \\
					\hline
				\end{tabular}
			\end{center}
		\end{table}
		...
		\begin{table}[H]
			...
			\begin{center}
				\begin{tabular}[c]{|c|c|c|c|}
					...
					\multicolumn{1}{c|}{\textbf{sys}}                                            \\
					\hline
					1                                          & 1m45.303s & 0m3.544s & 0m6.513s \\
					\hline
					2                                          & 1m43.955s & 0m3.476s & 0m6.326s \\
					\hline
					3                                          & 1m43.938s & 0m3.523s & 0m6.382s \\
					\hline
				\end{tabular}
			\end{center}
		\end{table}
		...
		\begin{table}[H]
			...
			\begin{center}
				\begin{tabular}[c]{|c|c|c|c|}
					...
					\multicolumn{1}{c|}{\textbf{sys}}                                            \\
					\hline
					1                                          & 3m16.849s & 0m8.208s & 0m2.255s \\
					\hline
					2                                          & 2m45.881s & 0m7.431s & 0m2.095s \\
					\hline
					3                                          & 2m57.825s & 0m7.761s & 0m2.115s \\
					\hline
				\end{tabular}
			\end{center}
		\end{table}
		...
		\begin{table}[H]
			...
			\begin{center}
				\begin{tabular}[c]{|c|c|c|c|}
					...
					\multicolumn{1}{c|}{\textbf{sys}}                                             \\
					\hline
					1                                          & 2m48.054s  & 0m7.488s & 0m2.119s \\
					\hline
					2                                          & 2m53.974s  & 0m7.598s & 0m2.123s \\
					\hline
					3                                          & 2m.13.947s & 0m7.341s & 0m2.040s \\
					\hline
				\end{tabular}
			\end{center}
		\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                           \\
				\hline
				1                                          & 0m5.128s & 0m0.210s & 0m0.086s \\
				\hline
				2                                          & 0m4.186s & 0m0.229s & 0m0.073s \\
				\hline
				3                                          & 0m2.774s & 0m0.228s & 0m0.076s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                           \\
				\hline
				1                                          & 0m4.870s & 0m0.222s & 0m0.083s \\
				\hline
				2                                          & 0m4.222s & 0m0.228s & 0m0.071s \\
				\hline
				3                                          & 0m2.765s & 0m0.234s & 0m0.072s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m16.252s & 0m4.075s & 0m0.997s \\
				\hline
				2                                          & 0m12.563s & 0m3.931s & 0m0.921s \\
				\hline
				3                                          & 0m13.220s & 0m3.965s & 0m0.975s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m13.381s & 0m4.021s & 0m0.976s \\
				\hline
				2                                          & 0m12.683s & 0m3.924s & 0m0.968s \\
				\hline
				3                                          & 0m12.958s & 0m3.883s & 0m0.951s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m14.552s & 0m6.628s & 0m1.886s \\
				\hline
				2                                          & 0m13.874s & 0m6.402s & 0m1.857s \\
				\hline
				3                                          & 0m14.230s & 0m6.501s & 0m1.818s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m50.808s & 0m6.168s & 0m2.358s \\
				\hline
				2                                          & 0m46.404s & 0m5.879s & 0m1.860s \\
				\hline
				3                                          & 0m36.898s & 0m5.832s & 0m2.003s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m29.654s & 0m5.908s & 0m1.833s \\
				\hline
				2                                          & 0m41.280s & 0m7.002s & 0m2.446s \\
				\hline
				3                                          & 0m39.303s & 0m6.856s & 0m1.958s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m11.358s & 0m0.483s & 0m0.553s \\
				\hline
				2                                          & 0m10.317s & 0m0.512s & 0m0.477s \\
				\hline
				3                                          & 0m10.658s & 0m0.486s & 0m0.500s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m10.730s & 0m0.498s & 0m0.642s \\
				\hline
				2                                          & 0m9.745s  & 0m0.455s & 0m0.474s \\
				\hline
				3                                          & 0m10.176s & 0m0.488s & 0m0.470s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m31.965s & 0m4.378s & 0m1.145s \\
				\hline
				2                                          & 0m23.455s & 0m4.274s & 0m1.025s \\
				\hline
				3                                          & 0m24.020s & 0m4.283s & 0m1.003s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m33.164s & 0m6.848s & 0m2.088s \\
				\hline
				2                                          & 0m32.873s & 0m7.054s & 0m2.088s \\
				\hline
				3                                          & 0m36.413s & 0m7.368s & 0m2.129s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                           \\
				\hline
				1                                          & 0m3.007s & 0m0.219s & 0m0.078s \\
				\hline
				2                                          & 0m2.918s & 0m0.219s & 0m0.085s \\
				\hline
				3                                          & 0m3.190s & 0m0.218s & 0m0.088s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                           \\
				\hline
				1                                          & 0m2.859s & 0m0.218s & 0m0.083s \\
				\hline
				2                                          & 0m2.582s & 0m0.232s & 0m0.067s \\
				\hline
				3                                          & 0m2.929s & 0m0.219s & 0m0.081s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m15.627s & 0m3.954s & 0m0.988s \\
				\hline
				2                                          & 0m15.153s & 0m3.928s & 0m0.960s \\
				\hline
				3                                          & 0m15.504s & 0m3.925s & 0m0.979s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m16.187s & 0m4.021s & 0m1.028s \\
				\hline
				2                                          & 0m15.441s & 0m3.892s & 0m1.019s \\
				\hline
				3                                          & 0m15.391s & 0m3.925s & 0m0.989s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
	...
	\begin{table}[H]
		...
		\begin{center}
			\begin{tabular}[c]{|c|c|c|c|}
				...
				\multicolumn{1}{c|}{\textbf{sys}}                                            \\
				\hline
				1                                          & 0m17.768s & 0m6.649s & 0m1.986s \\
				\hline
				2                                          & 0m17.426s & 0m6.628s & 0m1.950s \\
				\hline
				3                                          & 0m18.449s & 0m6.859s & 0m2.088s \\
				\hline
			\end{tabular}
		\end{center}
	\end{table}
