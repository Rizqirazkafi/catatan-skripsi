...
\begin{adjustwidth}{7mm}{}
	...
	\begin{adjustwidth}{6.3mm}{}
		...
		Konten flake.lock adalah sebagai berikut:
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{images/lock-home-manager.png}
			\caption{home-manager}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{images/lock-testing-website.png}
			\caption{testing-website}
		\end{figure}

	\end{adjustwidth}
	\subsection{Configuration.nix}
	\vspace{-3mm}
	\begin{adjustwidth}{6.3mm}{}
		Dalam file configuration.nix, terdapat beberapa konfigurasi sistem dasar
		yang diterapkan. Adapun beberapa file atau nixos module yang di import
		adalah sebagai berikut:
    \begin{minted}[breaklines]{nix}
imports = [
  ...
  ./nginx.nix
    ...
    \end{minted}
    Kemudian, flake dan home-manager akan di aktifkan dengan konfigurasi
    berikut:
    \begin{minted}[breaklines]{nix}
...
home-manager = {
  ...
  users.rizqirazkafi = import ../home.nix;
    ...
    \end{minted}
    Setelah itu, ada konfigurasi untuk menambahkan \textit{authorized} ssh keys:
    \begin{minted}[breaklines]{nix}
users.users.rizqirazkafi = {
  ...
  openssh.authorizedKeys.keys = [
    # Nitro
    "ssh-ed25519 AAAAC3Nxxxx"
    # nixosvm-efi
    "ssh-ed25519 AAAAC3xxxx"
  ];

};
users.users.root.openssh.authorizedKeys.keys = [
  # Nitro
  "ssh-ed25519 AAAAC3NzaC1xxxx"
  # nixosvm-efi
  "ssh-ed25519 AAAAC3NzaC1lZxxxx"
];
    \end{minted}
	\end{adjustwidth}
