...
\titlecontents{chapter}% <section-type>
  ...
  {\bfseries BAB \thecontentslabel}% <numbered-entry-format>
...
\begin{adjustwidth}{7mm}{}
  ...
  \begin{adjustwidth}{6.3mm}{}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.45\textwidth]{images/ansible-packages.png}
      \caption{Installed Packages}
    \end{figure}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.45\textwidth]{images/ansible-copy.png}
